...
b1q9= Question.create(q_text:"Favourite soda?", pre_req_ans: 24)
Answer.create(a_text: "Coke", question_id: 9)
Answer.create(a_text: "Sprite", question_id: 9)

ale_detail_qn= Question.create(q_text:"If you were part of a movie production team, what would you do?", pre_req_ans: 27)
...
ale_detail_qn2= Question.create(q_text:"Where would you get your coffee from?", pre_req_ans: 28)
...
b2q12= Question.create(q_text: "Coffee or Tea?", pre_req_ans: 25)
Answer.create(a_text: "Coffee", question_id:12)
Answer.create(a_text: "Tea", question_id:12)

lager_detail_qn= Question.create(q_text:"Favourite alcohol other than Beer", pre_req_ans: 36)
...
lager_detail_qn2= Question.create(q_text:"How many countries have you visited", pre_req_ans: 37)
...
b3q15= Question.create(q_text: "Salt? or Pepper?", pre_req_ans: 26)
Answer.create(a_text: "Salt", question_id: 15)
Answer.create(a_text: "Pepper", question_id: 15)

other_detail_qn= Question.create(q_text:"What do you do in your free time?", pre_req_ans: 44)
...
other_detail_qn2= Question.create(q_text:"Favourite Season?", pre_req_ans: 45)
