q1= Question.create(q_text: "What is your favourite type of chocolate", pre_req_ans: nil)
Answer.create(a_text: "Milk", question_id: 1)
Answer.create(a_text: "Dark", question_id: 1)
Answer.create(a_text: "White", question_id: 1)

q2= Question.create(q_text: "What is your favourite coffee roast", pre_req_ans: nil)
...
q3= Question.create(q_text: "What is your favourite pizza Crust", pre_req_ans: nil)
...
q4= Question.create(q_text: "What is your favourite Breakfast", pre_req_ans: nil)
...
q5= Question.create(q_text: "If you were a fruit, what would you be?", pre_req_ans: nil)
...
q6= Question.create(q_text: "What is your favourite scent?", pre_req_ans: nil)
...
q7= Question.create(q_text: "What would you do with a million dollars?", pre_req_ans: nil)
...
pre_req_qn= Question.create(q_text:"What is your ideal vacation?")
...
b1q9= Question.create(q_text:"Favourite soda?", pre_req_ans: 25)
Answer.create(a_text: "Coke", question_id: 9)
Answer.create(a_text: "Sprite", question_id: 9)

ale_detail_qn= Question.create(q_text:"If you were part of a movie production team, what would you do?", pre_req_ans: 28)
...
ale_detail_qn2= Question.create(q_text:"Where would you get your coffee from?", pre_req_ans: 29)
...
b2q12= Question.create(q_text: "Coffee or Tea?", pre_req_ans: 26)
Answer.create(a_text: "Coffee", question_id:12)
Answer.create(a_text: "Tea", question_id:12)

lager_detail_qn= Question.create(q_text:"Favourite alcohol other than Beer", pre_req_ans: 37)
...
lager_detail_qn2= Question.create(q_text:"How many countries have you visited", pre_req_ans: 38)
...
b3q15= Question.create(q_text: "Salt? or Pepper?", pre_req_ans: 27)
Answer.create(a_text: "Salt", question_id: 15)
Answer.create(a_text: "Pepper", question_id: 15)

other_detail_qn= Question.create(q_text:"What do you do in your free time?", pre_req_ans: 45)
...
other_detail_qn2= Question.create(q_text:"Favourite Season?", pre_req_ans: 46)
